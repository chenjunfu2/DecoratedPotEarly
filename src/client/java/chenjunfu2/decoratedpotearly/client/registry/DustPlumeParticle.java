...
public class DustPlumeParticle extends AscendingParticle
{
	...
	)
	{
		...
		this.red = ColorHelper.Argb.getRed(12235202) / 255.0F - f;
		this.green = ColorHelper.Argb.getGreen(12235202) / 255.0F - f;
		this.blue = ColorHelper.Argb.getBlue(12235202) / 255.0F - f;
	}
