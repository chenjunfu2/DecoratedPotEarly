...
**没有移植的部分：**
- 如果cracked方块状态设置为true，无论使用何种方式破坏饰纹陶罐，饰纹陶罐都会碎裂 (大部分情况下用不到，暂时偷懒不做)
- 饰纹陶罐会被弹射物击毁 (此特性属于副作用，且高版本中绑定游戏规则，不予移植)
- 陶罐可使用战利品表，并且会从其LootTableNBT标签中读取 (陶罐不会在世界中主动生成，战利品表无意义)
- 无纹样的饰纹陶罐会生成于试炼密室 (不存在试炼密室结构)
